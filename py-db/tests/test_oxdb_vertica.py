...
VERTICA_CONNECTION_NAME = 'VERTICA_PRIMARY'


class TestVerticaOXDB(unittest.TestCase):
    def setUp(self):
        self.dbh = OXDB(VERTICA_CONNECTION_NAME)
    ...
    def test_commit(self):
        with OXDB(VERTICA_CONNECTION_NAME) as oxdb:
